...
mkFeature {
  ...
  options =
    ...
    in
    {
      ...
      directory = mkOption {
        type = types.str;
        default = "${config.ordenada.features.xdg.baseDirs.cacheHome}/emacs/gnus";
        ...
        config =
          ...
          ''
            ...
            (with-eval-after-load 'gnus
              ...
              ${lib.optionalString emacs.advancedUser ''
              ...
              ${lib.optionalString (messageArchiveMethod != null) ''
                (setopt gnus-message-archive-method
                        '(${toString messageArchiveMethod}))
              ''}
              ${lib.optionalString (messageArchiveGroup != null) ''
              ...
              (setopt gnus-posting-styles '(${
                toString (
                  lib.mapAttrsToList (name: acc: ''
                    ...
                    ${lib.optionalString mail.msmtp.enable (
                      with config.accounts.email.accounts.${name}.smtp;
                      ''
              ...
              (setopt gnus-secondary-select-methods '(${
                lib.optionalString mail.mbsync.enable (
                  toString (
                    lib.mapAttrsToList (
                      name: acc: with config.accounts.email; ''
                        (nnmaildir "${name}"
                         (directory
              ...
              (nnfolder "archive"
                        (nnfolder-directory
                         "${config.accounts.email.maildirBasePath}/archive")
                        (nnfolder-active-file
                         "${config.accounts.email.maildirBasePath}/archive/active")
