...
{
  options.ordenada.features.emacs.vertico = {
    enable = mkEnableOption "the Emacs vertico feature";
    package = mkPackageOption pkgs [ "emacsPackages" "vertico" ] { };
  };
  config.home-manager = mkHomeConfig config "emacs.vertico" (user: {
