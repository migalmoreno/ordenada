...
in
{
  options.ordenada.features.emacs.smartparens = {
    enable = mkEnableOption "the Emacs smartparens feature";
  ...
  config.home-manager = mkHomeConfig config "emacs.smartparens" (user: {
