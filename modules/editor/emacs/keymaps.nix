...
let
  ...
  inherit (pkgs.lib.ordenada) mkElispConfig mkEnableTrueOption mkHomeConfig;
in
{
  options.ordenada.features.emacs.keymaps = {
  ...
  config.home-manager = mkHomeConfig config "emacs.keymaps" (user: {
