...
{
  options.ordenada.features.emacs.vterm = {
    enable = mkEnableOption "the Emacs vterm feature";
    package = mkPackageOption pkgs [ "emacsPackages" "vterm" ] { };
  };
  config.home-manager = mkHomeConfig config "emacs.vterm" (user: {
