...
in
{
  options.ordenada.features.emacs.project = {
    enable = mkEnableOption "Emacs Project feature";
    extraDominatingFiles = mkOption {
  ...
  config.home-manager = mkHomeConfig config "emacs.project" (user: {
    programs.emacs = mkElispConfig {
      ...
      config = ''
        ...
        (setopt ordenada-project-dominating-files
                ${elisp.mkList user.features.emacs.project.extraDominatingFiles})
